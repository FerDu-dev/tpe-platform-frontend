...
import { salesRequisitionService } from '../../../services/salesRequisitionService';
...
export const loadRequisitions = createAsyncThunk(
    ...
    async (params: { page?: number; limit?: number; status?: string } & RequisitionFilters = {}, { getState, rejectWithValue }) => {
        ...
        try {
            const response = await salesRequisitionService.fetchRequisitions(cleanFilters);
            return response;
        } catch (error) {
...
export const createRequisition = createAsyncThunk(
    ...
    async (data: Partial<Requisition>, { rejectWithValue }) => {
        try {
            return await salesRequisitionService.createRequisition(data);
        } catch (error: any) {
...
export const updateRequisition = createAsyncThunk(
    ...
    async ({ id, data }: { id: number | string; data: Partial<Requisition> }, { rejectWithValue }) => {
        try {
            return await salesRequisitionService.updateRequisition(id, data);
        } catch (error: any) {
            return rejectWithValue(error.response?.data?.message || error.message);
        }
    }
...
export const loadRecruitmentAnalytics = createAsyncThunk(
    'salesRequisitions/loadAnalytics',
    async (params: { companyId?: number; stateId?: number; status?: string; jobRequisitionId?: number; excludeRejected?: boolean } = {}, { rejectWithValue }) => {
        try {
            return await salesRequisitionService.fetchRecruitmentAnalytics(params);
        } catch (error) {
            return rejectWithValue((error as Error).message);
        }
    }
...
export const deleteRequisition = createAsyncThunk(
    ...
    async (id: number | string, { rejectWithValue }) => {
        try {
            await salesRequisitionService.deleteRequisition(id);
            return id;
        } catch (error: any) {
            return rejectWithValue(error.response?.data?.message || error.message);
        }
...
// Selectors
export const selectRequisitions = (state: RootState) => state.salesRequisitions.requisitions;
export const selectRequisitionsLoading = (state: RootState) => state.salesRequisitions.loading;
export const selectRequisitionsError = (state: RootState) => state.salesRequisitions.error;
export const selectRequisitionsMeta = (state: RootState) => state.salesRequisitions.meta;
export const selectRequisitionsFilters = (state: RootState) => state.salesRequisitions.filters;
export const selectRecruitmentAnalytics = (state: RootState) => state.salesRequisitions.analytics;
export const selectAnalyticsLoading = (state: RootState) => state.salesRequisitions.analyticsLoading;

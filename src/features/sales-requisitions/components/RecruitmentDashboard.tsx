...
import {
    ...
    setFilters
} from '../store/salesRequisitionsSlice';
...
const RecruitmentDashboard: React.FC = () => {
    ...
    useEffect(() => {
        if (filters.jobRequisitionId) {
            setLoadingOps(true);
            salesRequisitionService.findOne(filters.jobRequisitionId.toString())
    ...
    const handleRefreshData = () => {
        ...
        if (filters.jobRequisitionId) {
            salesRequisitionService.findOne(filters.jobRequisitionId.toString()).then(setFullRequisition);
        }
    };

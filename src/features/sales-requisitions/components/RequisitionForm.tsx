...
import {
    selectPositions, selectCompanies,
    addPosition, removePosition, setCompanies
} from '../../../store/masterDataSlice';
import { createRequisition, updateRequisition } from '../store/salesRequisitionsSlice';
...
const RequisitionForm: React.FC<RequisitionFormProps> = ({ open, onClose, requisition, loading }) => {
    ...
    const handleCreateNew = (type: 'company' | 'position') => {
        ...
        if (type === 'position') dispatch(addPosition(newItemName));

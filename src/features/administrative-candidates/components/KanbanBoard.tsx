...
import { loadKanbanStage } from '../store/adminCandidatesSlice';
import { useAppDispatch, useAppSelector } from '../../../app/store';
import type { Candidate } from '../../../types';
import { STAGE_COLORS } from '../../../services/adminCandidateService';
...
const KanbanBoard: React.FC<KanbanBoardProps> = ({ onCardClick, totalCountsByStage }) => {
    ...
    const kanbanData = useAppSelector(state => state.adminCandidates.kanban);
    const filters = useAppSelector(state => state.adminCandidates.filters);
